...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW,
      CW_USEDEFAULT, 250, 250, 250, nullptr, nullptr, hInstance, nullptr);

   CreateWindow(L"button", L"Red",
	   WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON,
	   10, 10, 90, 30, hWnd, (HMENU)RBUTTON11_ID, hInstance, NULL);
   CreateWindow(L"button", L"Blue",
	   WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON,
	   10, 35, 90, 30, hWnd, (HMENU)RBUTTON13_ID, hInstance, NULL);
   CreateWindow(L"button", L"Green",
	   WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON,
	   10, 60, 90, 30, hWnd, (HMENU)RBUTTON12_ID, hInstance, NULL);

   CreateWindow(L"button", L"Rhombus",
	   WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON,
	   120, 10, 90, 30, hWnd, (HMENU)RBUTTON21_ID, hInstance, NULL);
   CreateWindow(L"button", L"Square",
	   WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON,
	   120, 35, 90, 30, hWnd, (HMENU)RBUTTON22_ID, hInstance, NULL);
   CreateWindow(L"button", L"Circle",
	   WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON,
	   120, 60, 90, 30, hWnd, (HMENU)RBUTTON23_ID, hInstance, NULL);
   CreateWindow(L"button", L"Star",
	   WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON,
	   120, 85, 90, 30, hWnd, (HMENU)RBUTTON24_ID, hInstance, NULL);
   ...
   CreateWindow(L"button", L"Draw",
	   ...
	   65, 130, 90, 30, hWnd, (HMENU)CHECKBOX_ID, hInstance, NULL);
