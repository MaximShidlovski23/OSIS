    ...
    case WM_PAINT:
        {
			...
			if (draw && drawX != -1) {
				...
				switch (shape)
				{
					case 0:
					{
						POINT p[4] = { drawX + 20, drawY - 30, drawX + 70, drawY + 10,
							drawX + 20, drawY + 45, drawX - 30, drawY + 10 };
						Polygon(hdc, p, 4);
					}
					break;
					case 1:
						Rectangle(hdc, drawX - 40, drawY - 20, drawX + 40, drawY + 20);
						break;
					case 2:
						Ellipse(hdc, drawX - 40, drawY - 20, drawX + 40, drawY + 20);
						break;
					case 3:
					{
